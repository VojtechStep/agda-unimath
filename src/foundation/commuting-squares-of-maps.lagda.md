...
Note how some of the vertices and the diagonals are not arbitrary.
...
is shown to be homotopic to the reflexive homotopy
`refl-htpy : tr ∘ bl ~ tr ∘ bl`, then the whole rectangle collapses (is
homotopic) to the [horizontal composition](foundation.homotopy-algebra.md)
